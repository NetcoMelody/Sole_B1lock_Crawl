...
def main(product_id,sku):
    ...
    print(f"🚀 Sending Suggestions request to StockX (query: {sku})...")
    try:
        resp = requests.post(
...
# D:\Project\pyproject\.venv\Scripts\python.exe D:\Project\pyproject\StockX_crawl\detial_product_with_nodeID.py
