...
async def main(sku):
    ...
    HEADERS =  {
        ...
        "x-session-id": "fbf069de-0a70-4e4d-8355-4627333a3a29",
        "x-stockx-session-id": "235a3846-2cc6-486d-8772-00eb8c26b97a",
        ...
        "x-px-os-version": "12",
        "x-px-uuid": "80c9b516-a991-11f0-8312-21b9018429f5",
        "x-px-device-fp": "bc95f2418c78c9a2",
        "x-px-device-model": "ALN-AL00",
        "x-px-os": "Android",
        "x-px-hello": "CwNQClEGAgUeUgoKAh4CAlUDHgsAAgEeAQJRCgMCCwcBClUG",
